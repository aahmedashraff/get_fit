...
class FatEditScreen extends StatefulWidget {
  static const screenName = "/height-screen";

  const FatEditScreen({Key key}) : super(key: key);

  @override
  State<FatEditScreen> createState() => _FatEditScreenState();
}

class _FatEditScreenState extends State<FatEditScreen> {
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Looks like we lost some bad fat :)",
                            style: TextStyle(
