...
class ChangePassInput extends StatefulWidget {
  final String label;
  ...
  ChangePassInput({
    ...
    this.updateStreamFunction,
    this.showViewPasswordIcon = false,
    @required this.isPassword = false,
  }) : super(key: key);
  @override
  _ChangePassInputState createState() => _ChangePassInputState();
}

class _ChangePassInputState extends State<ChangePassInput>
